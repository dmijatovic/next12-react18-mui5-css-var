...
MyDocument.getInitialProps = async (ctx) => {
  ...
  // console.log("emotionStyles...", emotionStyles)
  // JUST use emoints Global component -> see _app.tsx
  // add custom style
  // emotionStyles.styles.push({
  //   key: 'rsd-style-global',
  //   ids: [],
  //   css: `:root{--rsd-accent-main:red;--rsd-primary-main:green;--rsd-secondary-main:blue;}
  //   `
  // })
